...
const Applications = () => {
  ...
  const handleEdit = (application) => {
    ...
    setFormData({
      ...
      documentationPath: application.documentationPath || ''
    })
    setShowModal(true)
  }
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-dark-800 rounded-xl p-6 w-full max-w-md mx-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-1">Documentation Path</label>
                <input
                  type="text"
                  value={formData.documentationPath}
                  onChange={(e) => setFormData({...formData, documentationPath: e.target.value})}
                  className="input-field w-full"
                  placeholder="Path to documentation file"
                />
              </div>
